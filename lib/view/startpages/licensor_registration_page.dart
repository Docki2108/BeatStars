...
class LicensorRegistrationPage extends StatefulWidget {
  const LicensorRegistrationPage({super.key});

  @override
  State<LicensorRegistrationPage> createState() =>
      _LicensorRegistrationPageState();
}
...
class _LicensorRegistrationPageState extends State<LicensorRegistrationPage> {
  @override
  void initState() {
    loginNode = FocusNode();
